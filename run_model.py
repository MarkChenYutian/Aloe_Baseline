...
def main(unused_argv):
  ...
  print(Fore.GREEN + "Descriptive Question: ", question_json["question"])
  print(Fore.GREEN + "Model Answer: ",
        eval_descriptive(load_monet_latents(base_dir, sample_scene_idx),
                         question_json))
  print(Fore.GREEN + "True Answer: ", question_json["answer"])

  question_json = questions_data[sample_scene_idx]["questions"][-1]
  print(Fore.GREEN + "Multiple-Choice Question: ", question_json["question"])
